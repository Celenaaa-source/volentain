...
const OPENING_LINES = [
  "Hai cuki, aku mau bilang sesuatu nih.",
  "Sebelumnnya, mksh banyak ya udah mau hadir di hidup aku. udah mau membuat hari-hari aku lebih berwarna. jujur aja aku merasa beruntung banget bisa jadi pacar kamu hari ini dan seterusnya. makasih juga kamu sudah sangat sabar dan sangat sayang ke aku, nerima semua kekurangan aku, dan selalu mau jadi tempat aku berpulang.",
  "Oh iya, hari ini hari valentine kan ya? hari dimana para cukimai mendapatkan banyak kasih sayang dan hadiah dari pasangan mereka. aku juga pengen banget ngasih kamu banyak kasih sayang dan hadiah yang spesial di hari ini. tapi aku masih bingung nih, kira-kira kamu mau gak ya, kalo ngerayain valentine bareng aku? cowok kamu yang paling ganteng ini, hehehe.",
...
function App() {
  ...
  const whatsappLink = `https://wa.me/${+6281231834928}?text=${encodeURIComponent(
    WHATSAPP_MESSAGE
  )}`;
      ...
      <section className={`card ${cardStateClass}`}>
        ...
        {!accepted && started ? (
          ...
          <div className="content accepted-copy">
            <p>Yay! Makasih cukinya aku, udah mau ngerayain valentine bareng aku. 😘</p>
            <p>
              Semoga Valentine kita kali ini lebih manis dan berkesan dari tahun-tahun sebelumnya ya 😍
              Aku janji bakal berusaha jadi ketua osis 2025 yang lebih baik lagi buat kamu untuk setiap harinya.
              jadi tolong jangan bosan-bosan menerima aku sebagai ketua osis kamu ya cuki. ❤️
            </p>
